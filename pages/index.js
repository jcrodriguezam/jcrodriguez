...
export default function Index({ posts, globalData }) {
  ...
  <div class="box">
    ...
    <div class="display">
      {/* <img class="imgStyle" src='static/img1.png' alt="img1" border="0" /> */}
      <img class="display-nft" src='https://images.unsplash.com/photo-1535207010348-71e47296838a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=385&q=80' alt="img1" border="0" />
